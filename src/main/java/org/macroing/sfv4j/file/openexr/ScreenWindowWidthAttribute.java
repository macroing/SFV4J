...
public final class ScreenWindowWidthAttribute extends Attribute {
	private final float screenWindowWidth;
	
	////////////////////////////////////////////////////////////////////////////////////////////////////
	
	public ScreenWindowWidthAttribute(final float screenWindowWidth) {
		super(Constants.ATTRIBUTE_NAME_SCREEN_WINDOW_WIDTH, Constants.ATTRIBUTE_TYPE_FLOAT);
	...
	public String toString() {
		return String.format("ScreenWindowWidthAttribute(screenWindowWidth = %s)", Float.toString(this.screenWindowWidth));
	}
