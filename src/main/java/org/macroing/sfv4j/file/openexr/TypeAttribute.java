...
public final class TypeAttribute extends Attribute {
	private final String value;
	
	////////////////////////////////////////////////////////////////////////////////////////////////////
	
	public TypeAttribute(final String value) {
		super(Constants.ATTRIBUTE_NAME_TYPE, Constants.ATTRIBUTE_TYPE_STRING);
	...
	public String toString() {
		return String.format("TypeAttribute(value = \"%s\")", this.value);
	}
}