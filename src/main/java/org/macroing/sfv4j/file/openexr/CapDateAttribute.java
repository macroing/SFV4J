...
public final class CapDateAttribute extends Attribute {
	private final String value;
	
	////////////////////////////////////////////////////////////////////////////////////////////////////
	
	public CapDateAttribute(final String value) {
		super(Constants.ATTRIBUTE_NAME_CAP_DATE, Constants.ATTRIBUTE_TYPE_STRING);
	...
	public String toString() {
		return String.format("CapDateAttribute(value = \"%s\")", this.value);
	}
}