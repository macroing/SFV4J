...
public final class LineOrderAttribute extends Attribute {
	private final int lineOrder;
	
	////////////////////////////////////////////////////////////////////////////////////////////////////
	
	public LineOrderAttribute(final int lineOrder) {
		super(Constants.ATTRIBUTE_NAME_LINE_ORDER, Constants.ATTRIBUTE_TYPE_LINE_ORDER);
	...
	public String toString() {
		return String.format("LineOrderAttribute(lineOrder = %s)", Integer.toString(this.lineOrder));
	}
