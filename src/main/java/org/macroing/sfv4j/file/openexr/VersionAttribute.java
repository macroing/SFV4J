...
public final class VersionAttribute extends Attribute {
	private final int version;
	
	////////////////////////////////////////////////////////////////////////////////////////////////////
	
	public VersionAttribute(final int version) {
	...
	public String toString() {
		return String.format("VersionAttribute(version = %s)", Integer.toString(this.version));
	}
