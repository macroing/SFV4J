...
public final class ScanLineOffsetTable implements OffsetTable {
	private final long[] offsets;
	
	////////////////////////////////////////////////////////////////////////////////////////////////////
	
	public ScanLineOffsetTable(final long[] offsets) {
		this.offsets = Objects.requireNonNull(offsets, "offsets == null");
	}
